...
export default function WhatsAppFAB(){
  ...
  return (
    <a
      ...
      className="fixed bottom-5 md:bottom-20  right-4 z-[2000] inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg ring-1 ring-black/5 transition-transform hover:scale-105 active:scale-95"
    >
      {/* WhatsApp SVG icon */}
